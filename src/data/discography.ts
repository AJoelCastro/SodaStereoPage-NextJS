...
export const albums: Album[] = [
  {
    ...
    tracks: ['¿Por Qué No Puedo Ser del Jet-Set?', 'Sobredosis de TV', 'Te Hacen Falta Vitaminas', 'Trátame Suavemente'],
  ...
  },
  {
    ...
    tracks: ['Nada Personal', 'Juego de Seducción', 'Imágenes Retro', 'Cuando Pase el Temblor'],
  ...
  },
  {
    ...
    aiHint: 'album cover',
    tracks: ['Signos', 'Prófugos', 'No Existo', 'Persiana Americana'],
  ...
  },
  {
    ...
    tracks: ['Signos', 'Juegos de Seducción', 'Cuando Pase el Temblor', 'Persiana Americana'],
  ...
  },
  {
    ...
    tracks: ['En la Ciudad de la Furia', 'Lo Que Sangra (La Cúpula)', 'Corazón Delator', 'Languis'],
  ...
  },
  {
    ...
    tracks: ['De Música Ligera', 'Té para 3', 'Hombre al Agua', 'Un millón de años luz', '(En) El Séptimo Día', 'Canción Animal'],
  ...
  },
  {
    ...
    aiHint: 'remix ep',
    tracks: ['No Necesito Verte (Para Saberlo)', 'Hombre al Agua (Remix)', 'No Existes', 'En el Borde'],
  ...
  },
  {
    ...
    tracks: ['Primavera 0', 'Luna Roja', 'Fue', 'Camaleón', 'Sweet Sahumerio'],
  ...
  },
  {
    ...
    tracks: ['Ella Usó Mi Cabeza Como Un Revólver', 'Paseando por Roma', 'Zoom', 'Efecto Doppler', 'Crema de Estrellas'],
