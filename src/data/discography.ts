...
export const albums: Album[] = [
  {
    ...
    tracks: [
      ...
      { name: 'Trátame Suavemente', audioUrl: placeholderAudioUrl }
    ],
  ...
  },
  {
    ...
    tracks: [
      ...
      { name: 'Prófugos', audioUrl: placeholderAudioUrl },
  ...
  },
  {
    ...
    tracks: [
      { name: 'En la Ciudad de la Furia', audioUrl: placeholderAudioUrl },
